...
export const LineShadowBtn = ({ text }) => {
  return (
    <NextBtnGraBorder>
      <NextBtnGraBg>
...
const NextBtnGraBorder = tw.div`w-full h-[5.25rem] rounded-full bg-gradient-to-t from-[#F79D00] via-[#CABE40] to-[#9AE286] drop-shadow-xl `;
